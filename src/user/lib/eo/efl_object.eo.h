#ifndef _EFL_OBJECT_EO_EO_H_
#define _EFL_OBJECT_EO_EO_H_
...
EAPI EAPI_WEAK const Efl_Class *efl_object_class_get(void) EINA_CONST;
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_parent_set(Eo *obj, Efl_Object *parent);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Efl_Object *efl_parent_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_name_set(Eo *obj, const char *name);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK const char *efl_name_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_comment_set(Eo *obj, const char *comment);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK const char *efl_comment_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_debug_name_override(Eo *obj, Eina_Strbuf *sb);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK int efl_event_freeze_count_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_finalized_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_invalidated_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_invalidating_get(const Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Efl_Object *efl_provider_find(const Eo *obj, const Efl_Class *klass);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Efl_Object *efl_constructor(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_destructor(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Efl_Object *efl_finalize(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_invalidate(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Efl_Object *efl_name_find(const Eo *obj, const char *search);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_event_thaw(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_event_freeze(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_event_callback_stop(Eo *obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_event_callback_forwarder_priority_add(Eo *obj, const Efl_Event_Description *desc, Efl_Callback_Priority priority, Efl_Object *source);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_event_callback_forwarder_del(Eo *obj, const Efl_Event_Description *desc, Efl_Object *new_obj);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Iterator *efl_children_iterator_new(Eo *obj) EFL_TRANSFER_OWNERSHIP EINA_WARN_UNUSED_RESULT;
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_composite_attach(Eo *obj, Efl_Object *comp_obj);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_composite_detach(Eo *obj, Efl_Object *comp_obj);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_composite_part_is(Eo *obj);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK void efl_allow_parent_unref_set(Eo *obj, Eina_Bool allow);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_allow_parent_unref_get(const Eo *obj);
#endif /* EFL_BETA_API_SUPPORT */
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_provider_register(Eo *obj, const Efl_Class *klass, const Efl_Object *provider);
 ...
 * @ingroup Efl_Object
 */
EAPI EAPI_WEAK Eina_Bool efl_provider_unregister(Eo *obj, const Efl_Class *klass, const Efl_Object *provider);

EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_DEL;
...
EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_INVALIDATE;
...
EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_NOREF;
...
EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_OWNERSHIP_UNIQUE;
...
EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_OWNERSHIP_SHARED;
...
EAPI EAPI_WEAK extern const Efl_Event_Description _EFL_EVENT_DESTRUCT;
